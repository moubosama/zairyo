...
//   木胴縁はG単体のXLS原典値が判明済み（集計表r85: 界壁面5.047㎡/戸 × X86=0.0098 = 0.049461m³/戸）で、
//   67戸平均0.0537との差-7.9%はタイプ差。原典が取れているので他部位と同じ±10%で判定する
const EXPECTED_VOLUME = [
  ['際根太 材積',       0.0246, 'm³', (mats) => qtyM3(mats, '際根太'), 12],
  ['間仕切木軸 材積',   1.1537, 'm³', (mats) => qtyM3(mats, '間仕切木軸'), 35],
  ['木胴縁 材積(ｻﾆﾃｨ)', 0.0537, 'm³', (mats) => qtyM3(mats, '木胴縁'), 10],
...
const EXPECTED_APPLIED = [
  ...
  ['木胴縁 適用後',       0.0537, 'm³', (mats) => qtyM3(mats, '木胴縁'), 10],
];
